...
(function () {
    ...
    openerp.Tour.register({
        ...
        steps: [
            ...
            {
                title:     _t("Complete Review"),
                content:   _t("<li>Click on <b>Complete Review</b> button to complete the senior review, which admits the patient and patient will be in <b>Cosultant Review</b> stage</li><br><b>or</b><br>" +
